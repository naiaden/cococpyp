...
struct UniformVocabulary {
  ...
  double probLimited(const Pattern& , const Pattern&, ContextCounts*, ContextValues*, CoCoInitialiser * const cci) const { return p0; }
  double probFull(const Pattern& , const Pattern&, ContextValues*, CoCoInitialiser * const cci) const { return p0; }
