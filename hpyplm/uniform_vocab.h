...
struct UniformVocabulary {
  ...
  double probLimited(const Pattern& , const Pattern&, ContextCounts*, ContextValues*, SNCBWCoCoInitialiser * const cci) const { return p0; }
  double probFull(const Pattern& , const Pattern&, ContextValues*, SNCBWCoCoInitialiser * const cci) const { return p0; }
