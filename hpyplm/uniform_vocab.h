...
struct UniformVocabulary {
  ...
  double probLimited(const Pattern&, const Pattern&, PatternCounts*, ContextCounts*, ContextValues*, CoCoInitialiser * const) const { std::cout << "STIUATION 0" << std::endl; return p0; }
